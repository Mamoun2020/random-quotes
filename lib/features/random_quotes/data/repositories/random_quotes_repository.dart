...
RandomQuotesRepository(this._randomQuotesLocalDataSource,this._randomQuotesRemoteDataSource, this.networkInfo);

Future<Either<Failure,SingleResponse<Quote>>> randomQuotes() async{
  if(await networkInfo.isConnected){
    try{
      final SingleResponse<Quote> response = await _randomQuotesRemoteDataSource.quotes();
    ...
    try{
      final localCacheQuote = await _randomQuotesLocalDataSource.getLastRandomQuote();
